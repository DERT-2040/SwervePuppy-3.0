...
//Swerve Drive
    //Drive Motor CAN IDs
        static constexpr int k_FrontLeft_Drive_CANID = 37;
        static constexpr int k_FrontRight_Drive_CANID = 11;
        static constexpr int k_BackLeft_Drive_CANID = 14;
        static constexpr int k_BackRight_Drive_CANID = 30;
    //Steer Motor CAN IDs
        static constexpr int k_FrontLeft_Steer_CANID = 20;
        static constexpr int k_FrontRight_Steer_CANID = 17;
        static constexpr int k_BackLeft_Steer_CANID = 16;
        static constexpr int k_BackRight_Steer_CANID = 15;
    ...
    //TODO: Use CTR Tuning software to set the CAN ids.
        ...
        static constexpr int k_FrontRight_Steer_Encoder_ID = 25;
        static constexpr int k_BackLeft_Steer_Encoder_ID = 3;
        static constexpr int k_BackRight_Steer_Encoder_ID = 21;
